...
@interface MasterViewController () <AddSceneViewControllerDelegate>
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    else if ([[segue identifier] isEqualToString:@"ShowAddSceneView"]) {
        AddSceneViewController *addController = (AddSceneViewController *)[[[segue destinationViewController] viewControllers] objectAtIndex:0];
...
#pragma mark - AddSceneViewControllerDelegate
